...
try swiftc "$SCRIPT_DIR/../src/main.swift" "$SCRIPT_DIR/../src/Analyzer.swift" "$SCRIPT_DIR/../src/Logger.swift" "$SCRIPT_DIR/../src/ScreenshotManager.swift" "$SCRIPT_DIR/../src/Utils.swift" -o "$MACOS_DIR/scribe"
