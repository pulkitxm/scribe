...
try swiftc -framework CoreWLAN -framework CoreAudio -framework AVFoundation -framework CoreMedia -framework CoreLocation "$SCRIPT_DIR/../src/"*.swift "$SCRIPT_DIR/../src/utils/"*.swift -o "$MACOS_DIR/scribe"
