        ...
        <CardDescription>
          ...
          {lowBatteryPeriods > 0 && (
            <span className="text-red-500 ml-1">
              {lowBatteryPeriods} low battery period(s)
            </span>
          )}
          {lowBatteryPeriods === 0 && (
            <span className="text-green-500 ml-1">Good battery health</span>
          )}
        </CardDescription>
      </CardHeader>
