...
export default function ScreenshotDetailView({
  ...
  const displayTitle =
    data.visualization?.display_badge || data.short_description;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span>
                      {Math.round(data.system_metadata.stats.cpu.used)}%
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span>
                      {Math.round(
                        data.system_metadata.stats.ram.used /
                          1024 /
                          1024 /
                          1024,
                      )}
                      GB /
                      {Math.round(
                        data.system_metadata.stats.ram.total /
                          1024 /
                          1024 /
                          1024,
                      )}
                  ...
                  <div className="flex justify-between">
                    ...
                    >
                      {Math.round(
                        data.system_metadata.stats.battery.percentage,
                      )}
                      %{data.system_metadata.stats.battery.isPlugged && " ⚡"}
                    </span>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                    ...
                    <div className="pt-2 border-t grid grid-cols-2 gap-2 text-xs">
                      {data.system_metadata.stats.network.link_speed && (
                        <div className="flex flex-col">
                          ...
                          <span>
                            {data.system_metadata.stats.network.link_speed} Mbps
                          </span>
                        </div>
                      )}
                      {data.system_metadata.stats.network.channel && (
                  ...
                  {(data.system_metadata.stats.network.rx_bytes !== undefined ||
                    data.system_metadata.stats.network.tx_bytes !==
                      undefined) && (
                    <div className="pt-2 border-t text-xs space-y-1">
                      <div className="flex justify-between items-center">
                        <span className="text-muted-foreground flex items-center gap-1">
                          <Activity className="h-3 w-3" /> Data Received
                        </span>
                        <span>
                          {data.system_metadata.stats.network.rx_bytes
                            ? (
                                data.system_metadata.stats.network.rx_bytes /
                                1024 /
                                1024
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-muted-foreground flex items-center gap-1">
                          <Activity className="h-3 w-3" /> Data Sent
                        </span>
                        <span>
                          {data.system_metadata.stats.network.tx_bytes
                            ? (
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  {data.system_metadata.audio.outputs &&
                    data.system_metadata.audio.outputs.length > 0 && (
                      <div className="space-y-1 pt-2 border-t">
                        <span className="text-muted-foreground text-xs uppercase">
                          Output Devices
                        </span>
                      ...
                      {data.system_metadata.video.sources.map((dev, i) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between text-xs text-muted-foreground">
                            ...
                            <span>
                              {dev.is_suspended ? "Suspended" : "Active"}
                            </span>
                          </div>
                        </div>
                      ))}
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {data.system_metadata.stats.display.brightness}%
                    </span>
                  </div>
                  ...
                  data.context.code_context.files_or_modules.length > 0 && (
                    <div className="space-y-1">
                      ...
                      <div className="max-h-[100px] overflow-y-auto space-y-1">
                        {data.context.code_context.files_or_modules.map(
                          (f, i) => (
                            <div
                              key={i}
