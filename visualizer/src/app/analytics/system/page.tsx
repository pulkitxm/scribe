...
import { ChevronLeft, Cpu, HardDrive, Battery, Volume2, Wifi, Monitor, Clock } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { getAllScreenshots, getSystemContextStats, getExtendedStats } from "@/lib/data";
...
export default function SystemPage() {
    ...
    const avgNetworkSignal = systemStats.signalData?.length > 0
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4 border-b border-border pb-6">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Deep dive into your environment, hardware usage, and system performance.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="text-xs text-muted-foreground mt-1">Average usage</div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="text-xs text-muted-foreground mt-1">Average level</div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-foreground">{signalPercent.toFixed(0)}%</div>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <RAMChart data={systemStats.hourlyTrends} totalRAM={systemStats.totalRAM} />
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <ConnectionTypeChart
                        data={systemStats.connectionTypes || []}
                    />
                    <StorageDistributionChart
                        used={systemStats.storageTrend?.length > 0 ? systemStats.storageTrend[systemStats.storageTrend.length - 1].used : 0}
                        free={systemStats.storageTrend?.length > 0 ? systemStats.storageTrend[systemStats.storageTrend.length - 1].free : 0}
